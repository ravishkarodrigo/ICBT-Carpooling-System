// Icon library — simple SVG icons used throughout the app
// All icons accept standard SVG props (width, height, className, etc.)
...
export function IconRoute(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width={24} height={24} {...props}>
      ...
      <path d="M6 19V9a6 6 0 0 1 6-6h3M18 5v10a6 6 0 0 1-6 6H9" />
    </svg>
  );
}
